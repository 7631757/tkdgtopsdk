...
class TaobaoTbkScOptimusPromotionMapData {
    ...
    public function getPromotionExtend() : TaobaoTbkScOptimusPromotionPromotionExtend{
        return $this->promotion_extend;
    }

    public function setPromotionExtend(TaobaoTbkScOptimusPromotionPromotionExtend $promotionExtend){
