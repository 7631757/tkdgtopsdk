...
class TaobaoTbkScOptimusPromotionPromotionExtend {
    ...
    public function getYoujiaCouponInfo() : TaobaoTbkScOptimusPromotionYoujiacouponinfo{
        return $this->youjia_coupon_info;
    }

    public function setYoujiaCouponInfo(TaobaoTbkScOptimusPromotionYoujiacouponinfo $youjiaCouponInfo){
