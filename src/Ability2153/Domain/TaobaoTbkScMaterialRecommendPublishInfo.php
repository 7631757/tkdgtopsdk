...
class TaobaoTbkScMaterialRecommendPublishInfo {
    ...
    public function getIncomeInfo() : TaobaoTbkScMaterialRecommendIncomeInfo{
        return $this->income_info;
    }

    public function setIncomeInfo(TaobaoTbkScMaterialRecommendIncomeInfo $incomeInfo){
